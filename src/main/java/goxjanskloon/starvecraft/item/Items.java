...
public interface Items{
    Item GARLAND=register("garland",new Item.Settings().maxDamage(120).component(DataComponentTypes.EQUIPPABLE,EquippableComponent.builder(EquipmentSlot.HEAD).model(EquipmentAssetKeys.GARLAND).damageOnHurt(false).build()).component(goxjanskloon.starvecraft.component.DataComponentTypes.SANITY_MODIFIER,1/2250f).component(goxjanskloon.starvecraft.component.DataComponentTypes.TICKS_PER_DECAY,1200));
